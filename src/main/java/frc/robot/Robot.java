...
public class Robot extends TimedRobot {
    ...
    private Timer m_timerDisabled;
    private boolean areWheelsInCoast;
    ...
    public void disabledInit() {
        m_robotContainer.setNeutralModeSwerve(NeutralModeValue.Brake);
        areWheelsInCoast = false;
    ...
    public void autonomousPeriodic() {
        m_robotContainer.limelightControl();
    }
